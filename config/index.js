module.exports = {
  ...
  siteTitle: 'Áudio do Zap', // Navigation and Site Title
  siteTitleAlt: 'Áudio do Zap', // Alternative Site title for SEO
  siteTitleManifest: 'Áudio do Zap',
  ...
  userTwitter: '@audiodozap', // Twitter Username - Optional
  ogSiteName: '', // Facebook Site Name - Optional
  ogLanguage: 'pt_BR', // Facebook Language
  googleAnalyticsID: 'UA-165297121-1',
